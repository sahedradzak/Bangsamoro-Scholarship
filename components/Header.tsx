      ...
      <div className="max-w-7xl mx-auto px-4 h-20 flex justify-between items-center">
        ...
        <nav className="hidden lg:flex items-center gap-10">
          <ul className="flex items-center gap-8 font-semibold text-slate-400">
            ...
            <li><a href="#" className="hover:text-emerald-400 transition-colors">Schemes</a></li>
            <li><a href="#" className="hover:text-emerald-400 transition-colors">How to Apply</a></li>
